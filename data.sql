...
insert into hosts(host_id, name, surname, country_country_id)
values (1, 'Lorenzo', 'Zurzolo', 1),
       (2, 'Penelope', 'Cruz', 2),
       (3, 'Cillian', 'Murphy', 3),
       (4, 'Marija', 'Kostadinovikj', 4),
       (5, 'Julia', 'Roberts', 5);

insert into guests(guest_id, name, surname, country_country_id)
values (1, 'Ana', 'Todorova', 2),
       (2, 'Marko', 'Markovski', 5),
       (3, 'Petar', 'Petrovski', 4),
       (4, 'Kristijan', 'Kristijanoski', 3),
       (5, 'Stefan', 'Stefanovski', 1);

insert into accommodations(id, name, category, host_host_id, num_rooms, is_rented)
values (1, 'Smestuvanje 1', 'ROOM', 1, 1, false),
